...
function ContactForm({ onSubmit }) {
  ...
  return (
    <form onSubmit={submit} className="w-full max-w-xl space-y-3 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-800">
      <div>
        <label className="mb-1 block text-xs font-medium text-slate-800 dark:text-slate-200">Name</label>
      ...
      <div>
        <label className="mb-1 block text-xs font-medium text-slate-800 dark:text-slate-200">Email</label>
      ...
      <div>
        <label className="mb-1 block text-xs font-medium text-slate-800 dark:text-slate-200">Message</label>
      ...
      <div className="flex justify-end">
        <button type="submit" className="inline-flex items-center rounded-md px-4 py-2 text-sm font-semibold text-white shadow-sm transition bg-main-gradient hover:brightness-105 active:brightness-95 focus-ring-main-gradient">
          Send
        </button>
      </div>
    </form>
