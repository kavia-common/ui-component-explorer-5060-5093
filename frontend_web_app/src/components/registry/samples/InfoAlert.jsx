  ...
  return (
    <div className="w-full max-w-2xl rounded-lg border border-blue-100 bg-blue-50/70 p-3 text-sm text-blue-800 shadow-sm dark:border-blue-900/40 dark:bg-blue-900/20 dark:text-blue-200">
      <div className="flex items-start gap-2">
        <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-main-gradient text-white shadow-sm ring-2 ring-blue-300/40 dark:ring-blue-800/50">i</span>
        <div>
