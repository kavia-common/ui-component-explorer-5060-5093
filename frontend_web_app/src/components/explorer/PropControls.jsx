          ...
          <label key={idx} className="text-sm">
            ...
            {c.type === 'select' ? (
              <select
                ...
                className="w-full rounded-md border border-gray-200 bg-white px-2 py-2 text-sm focus:outline-none focus-ring-main-gradient dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100"
              >
                {(c.options || []).map((opt) => (
